...
namespace ERP_GMEDINA.Controllers
{
    public class SalidaController : Controller
    {
        ...
        // GET: /Salida/
        [SessionManagerAttribute("Salida/Index")]
        ...
        //    var lastRecord = db.tbSalida.OrderByDescending(x => x.sal_Id).FirstOrDefault().sal_Id;
        ...
        [SessionManagerAttribute("Salida/Details")]
        ...
        // GET: /Salida/Create
        [SessionManagerAttribute("Salida/Create")]
        ...
        public ActionResult Create([Bind(Include = "bod_Id,fact_Id,fact_Codigo,sal_FechaElaboracion,estm_Id,tsal_Id,tdev_Id, sal_BodDestino, sal_EsAnulada, sal_RazonAnulada,vSalidaDetalle")] tbSalida tbSalida)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        var vFactura = db.tbFactura.Where(x => x.fact_Codigo == "1").Select(x => x.fact_Id).SingleOrDefault();
                        //tbSalida.bod_Id
        ...
        // GET: /Salida/Edit
        [SessionManagerAttribute("Salida/Edit")]
